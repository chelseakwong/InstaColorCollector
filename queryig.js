...
var masterPath = '/Users/chelseakwong/Pictures/tragedies/';
...
var startDate = Math.floor(new Date(2015, 10, 10, 0, 0, 0, 0).getTime()/1000.);
// this is the latest image you want to download:
var endDate = Math.floor(new Date(2015, 11, 15, 23, 59, 0, 0).getTime()/1000.);
...
// keeping track of filters
var filters = {};
var filterCount = 0;

var countDownloaded = 0;
var queryMaxLength = 5000;
...
// instagram user at the location
...
function getIG()
{
    ig.tag_media_recent((urlencode(searchTerm)),{
        ...
        function(err, medias, pagination, remaining, limit){
            ...
            filters[String("name"+filterCount)] = new Array();
            ...
            for(var i = 0;i<medias.length;i++){
                ...
                if(ts>startDate && ts<endDate) {
                    ...
                    filters[String("name"+filterCount)].push(filter);
            ...
            || !pagination.next_max_tag_id || mt.lessThan(absminID)) {
                ...
                // calling pagination.next_max_tag_id paginates
